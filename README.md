...
- [OHDSI/ETL-LambdaBuilder](https://github.com/OHDSI/ETL-LambdaBuilder) - CDM Builder leveraging AWS Lambda
...
- [housecat-inc/scratch](https://github.com/housecat-inc/scratch) - Setup for Agent Computers
...
- [iximiuz/client-go-examples](https://github.com/iximiuz/client-go-examples) - A collection of mini-programs demonstrating Kubernetes client-go usage.
...
- [nexusdatalabs/grantsdataportal.xyz](https://github.com/nexusdatalabs/grantsdataportal.xyz) - 🌲 Historical snapshot of Gitcoin Grants Stack era data, preserved for reproducibility and research
...
- [NetCoreTemplates/razor-ssg](https://github.com/NetCoreTemplates/razor-ssg) - .NET 10 Statically Generated, CDN hostable Tailwind Razor Pages Website
...
- [microsoft/unified-data-foundation-with-fabric-solution-accelerator](https://github.com/microsoft/unified-data-foundation-with-fabric-solution-accelerator) - Unified Data Foundation with Microsoft Fabric with Options to Integrate with Azure Databricks and Microsoft Purview
- [brevdev/workshop-build-an-agent](https://github.com/brevdev/workshop-build-an-agent) - 
- [NVIDIA/GenerativeAIExamples](https://github.com/NVIDIA/GenerativeAIExamples) - Generative AI reference workflows optimized for accelerated infrastructure and microservice architecture.
- [jupyterlite/xeus-lite-demo](https://github.com/jupyterlite/xeus-lite-demo) - JupyterLite template repository with xeus kernels and pre-installed packages
...
- [santhoshtr/hm](https://github.com/santhoshtr/hm) - home-maker: A single Makefile that installs and upgrades every tool on your dev machine — CLI utilities, language toolchains, desktop apps — grouped by purpose, with a fuzzy-search frontend to run any
...
- [mathieu-benoit/sail-sharp](https://github.com/mathieu-benoit/sail-sharp) - Sail Sharp - Security best practices with .NET Core, Docker & Kubernetes
...
- [aws-samples/sample-building-with-strands-course](https://github.com/aws-samples/sample-building-with-strands-course) - 
...
- [akshay355a/Jupyter-notebook-on-Android-TERMUX-](https://github.com/akshay355a/Jupyter-notebook-on-Android-TERMUX-) - "Step-by-step guide and ready-to-use setup for running Jupyter Notebook on Android via Termux. Includes solutions for common build errors, dependency fixes, and Rust integration."
...
- [jeanlucdupont/EXEfromCER](https://github.com/jeanlucdupont/EXEfromCER) - PoC that downloads an executable from a public SSL certificate
